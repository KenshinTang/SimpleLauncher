...
public abstract class XulAnimationDrawable extends XulDrawable {
	...
	public static XulDrawable buildAnimation(GifDrawable gif, String url, String imageKey, int width, int height) {
		if (gif == null) {
			return null;
		}
		XulGifAnimationDrawable drawable = XulGifAnimationDrawable.buildAnimation(gif, width, height);
		if (drawable != null) {
			drawable._url = url;
			drawable._key = imageKey;
		}
